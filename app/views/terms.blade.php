...
@section('content')
    ...
    <article>
        ...
        <p>(Or you selfhost I on your own server).</p>
    </article>

    <article>
        <h2>What about the screenshots?</h2>
        <p>All screenshots someone creates via Screeenly have a lifetime of <strong>12 hours! (Screeenly does not host your images)</strong> After this time the file will be deleted from our server. Forever.</p>

        <p>Concering privacy, Screeenly is hosted on <a href="//uberspace.de">Uberspace</a>, a German hosting solution. All images remain on those servers and never leave Europe.</p>
    </article>
    ...
    <article>
        <h2>Good to know</h2>
        <p>We also use <a href="//google.com/analytics">Google Analytics</a> to analyse the usage of Screeenly</p>
    </article>
